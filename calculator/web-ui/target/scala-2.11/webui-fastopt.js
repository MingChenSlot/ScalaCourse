...
$c_Lcalculator_Calculator$.prototype.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z = (function(rightExpr, visited, references$1) {
  _detectInfiniteLoop: while (true) {
    var x1 = rightExpr;
    if ((!$is_Lcalculator_Literal(x1))) {
      if ($is_Lcalculator_Ref(x1)) {
        var x3 = $as_Lcalculator_Ref(x1);
        var exprRef = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x3.name$2, references$1);
        if (visited.contains__O__Z(exprRef)) {
          return true
        } else {
          var temp$visited = $as_sci_Set(visited.$$plus__O__sc_Set(exprRef));
          rightExpr = exprRef;
          visited = temp$visited;
          continue _detectInfiniteLoop
        }
      } else if ($is_Lcalculator_Plus(x1)) {
        var x4 = $as_Lcalculator_Plus(x1);
        return (!(!(this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x4.a$2, visited, references$1) | this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x4.b$2, visited, references$1))))
      } else if ($is_Lcalculator_Minus(x1)) {
        var x5 = $as_Lcalculator_Minus(x1);
        return (!(!(this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x5.a$2, visited, references$1) | this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x5.b$2, visited, references$1))))
      } else if ($is_Lcalculator_Times(x1)) {
        var x6 = $as_Lcalculator_Times(x1);
        return (!(!(this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x6.a$2, visited, references$1) | this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x6.b$2, visited, references$1))))
      } else if ($is_Lcalculator_Divide(x1)) {
        var x7 = $as_Lcalculator_Divide(x1);
        return (!(!(this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x7.a$2, visited, references$1) | this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(x7.b$2, visited, references$1))))
      } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if (this.detectInfiniteLoop$1__p1__Lcalculator_Expr__sci_Set__sci_Map__Z(jsx$2, $as_sci_Set(jsx$1), references)) {
      return (NaN)
    } else {
      var x1 = expr;
      if ($is_Lcalculator_Literal(x1)) {
        ...
        var x3 = $as_Lcalculator_Ref(x1);
        var ref = references.get__O__s_Option(x3.name$2);
        if ($is_s_Some(ref)) {
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return (($uI(remainingCharsCount$1.apply__O()) >= 15) ? "green" : ((($uI(remainingCharsCount$1.apply__O()) < 15) && ($uI(remainingCharsCount$1.apply__O()) >= 0)) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    return new $c_T2().init___O__O(name, new $c_Lcalculator_Signal().init___F0(expr$2))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
